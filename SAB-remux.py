...
"""SABnzbd entry point for unattended MP4 remuxing.
...
Usage:
    ...
    the completed download folder automatically; for a manual test, run:
        ...
        python3 SAB-remux.py "/path/to/completed/download"
...
def main(arguments: list[str]) -> int:
    if len(arguments) < 2 or not arguments[1].strip():
        print("Usage: SAB-remux.py <SAB download folder>", file=sys.stderr)
        return 2
